...
namespace AspNetCoreApi.Dal.Extensions
{
    ...
    {
        public static void AddDalBootstrapper(this IServiceCollection services, Action<DbContextOptionsBuilder> options, ServiceLifetime contextLifetime = ServiceLifetime.Scoped, ServiceLifetime optionsLifetime = ServiceLifetime.Scoped)
        {
